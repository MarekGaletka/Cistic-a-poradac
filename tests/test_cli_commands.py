...
class TestCmdSimilarFormats:
    def test_similar_json(self, capsys):
        ...
        pair = SimilarPair(path_a="/a.jpg", path_b="/b.jpg", distance=3, hash_a="0" * 16, hash_b="1" * 16)
    ...
    def test_similar_tsv(self, capsys):
        ...
        pair = SimilarPair(path_a="/a.jpg", path_b="/b.jpg", distance=1, hash_a="0" * 16, hash_b="1" * 16)
...
class TestCmdMetadataMerge:
    def test_no_groups(self, capsys):
        ...
        with patch("godmode_media_library.cli._get_catalog", return_value=mock_cat):
            args = argparse.Namespace(catalog=None, group=None, out_dir=None, apply=False, exiftool_bin="exiftool", dry_run=False)
